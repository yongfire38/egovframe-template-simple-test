...
public class EgovBBSManageAPIController {
	...
	public ResultVO updateBoardArticle(final MultipartHttpServletRequest multiRequest,
		...
		} else if (isAuthenticated && jwtVerification.isVerification(request)) {
	...
	@ResponseBody
	public ResultVO deleteBoardArticle(@RequestBody BoardVO boardVO, HttpServletRequest request)
